...
cp forecast_site/public/index.html forecast_site/public/events.js forecast_site/public/event_diagnostics.js forecast_site/public/sitemap.xml forecast_site/public/robots.txt "$RUNNER_TEMP/event-site/forecast_site/public/"
