...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the dedicated 30-day ETH forecast from the master dataset.")
...
def resolve_output_dir(output_dir: str, drive_root: str) -> str:
    if output_dir:
        return output_dir
    if drive_root:
        return str(Path(drive_root) / "outputs" / "30d")
    return "eth_forecast_outputs_30d"
